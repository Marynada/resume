  ...
  res.render('education', {
    ...
    main: {
      ...
      educations: [
        ...
        {
          name: 'Аграрний університет',
          isEnd: true,
        },
        {
          name: 'Педагогічний університет',
          isEnd: true,
        },
      ],
      certificates: [
    ...
    reviewList: [
      {
        ...
        reviewBody: {
          ...
          text: [
            'Цей ноутбук має гарний дизайн та добре виконує свої основні функції. Швидкість роботи та продуктивність в цілому є на задовільному рівні. Крім того, присутній достатній обсяг памяті та потужність акумулятора.',
